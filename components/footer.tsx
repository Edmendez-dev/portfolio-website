...
export function Footer() {
  ...
  const t = useTranslations("app.footer_section");

  return (
    <footer className="border-t border-accent/10 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 pb-12 border-b border-accent/10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground mt-4">
              <MessageCircleMore className="inline-block mr-2 w-4 h-4" />
              {t("lets_talk")}
            </p>
          </div>
        </div>
